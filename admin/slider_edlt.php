...
$row1 = $mysqli->select1(0, 1, '*', 'yycms_slider', 'where id = '.$_GET['id'].'');
?>
<!DOCTYPE html>
<html>
<head>
      ...
      <form class="layui-form" action="action.php" method="post">
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" name="title" lay-verify="required" class="layui-input" value="<?php echo $row1['title'];?>">
          </div>
        </div>
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <div class="input-group">
              <input type="text" name="picpath" style="width:350px;" class="layui-input" value="<?php echo $row1['picpath'];?>">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block w500">
            <div class="input-group">
              <input type="text" name="link" style="width:350px;" class="layui-input" value="<?php echo $row1['link'];?>">
            </div>
          </div>
        </div>
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline">
            <input type="text" name="sort" lay-verify="required" class="layui-input" value="<?php echo $row1['sort'];?>">
          </div>
        </div>
        <div class="layui-form-item">
          <div class="layui-input-block">
		  <input type="hidden" name="yycms" value="xghd">
