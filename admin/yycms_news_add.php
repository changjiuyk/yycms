  ...
  <div class="layui-card layui-card-open">
    <div class="layui-card-body">
      <form class="layui-form" action="action.php" method="post">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline w500">
            <div class="input-group">
              <input type="text" style="width:408px;" name="pic" value="" class="layui-input">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" name="link" class="layui-input" value="">
          </div>
        </div>
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            ...
            <script id="content" name="content" style="width:100%;height:400px;" type="text/plain"></script>
      ...
      editor.render("content");
        ...
        <div class="layui-form-item">
          <div class="layui-input-block">
		  <input type="hidden" name="yycms" value="tjxw">
