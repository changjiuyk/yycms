...
function() {
    ...
    function(e, t, n) {
        ...
        var a = function() {
            ...
            },
            {
                key: "update",
                value: function() {
                    this.template.infoVersion.innerHTML = "x3",
        ...
        var l = function() {
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    1 == 2 ? (this.player.template.videoWrap.addEventListener("click",
                    function() {
                        e.toggle()
    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            a += '</span>\n        </button>\n  <button  onclick="',
            a += r.front,
            a += '();"  class="dplayer-icon  icon-sj"  data-balloon="',
            a += s(l("Front")),
            a += '" data-balloon-pos="up" style="display:',
            a += r.front && r.front ? '': 'none',
            a += '"> \n  </button>\n  <button  onclick="',
            a += r.next,
            a += '();"  class="dplayer-icon  icon-xj"  data-balloon="',
            a += s(l("Next")),
            a += '" data-balloon-pos="up" style="display:',
            a += r.next && r.next ? '': 'none',
            a += '"> \n  </button>\n   <button  onclick="',
            a += r.line,
            a += '();"  class="dplayer-icon icon-line"  data-balloon="',
            a += s(l("Line")),
            a += '" data-balloon-pos="up" style="display:',
            a += r.line && r.line ? "": "none",
            ...
            a += '\n     <button  onclick="',
            a += r.list,
            a += '();"  class="dplayer-icon icon-list"  data-balloon="',
            a += s(l("List")),
            a += '" data-balloon-pos="up" style="display:',
            a += r.list && r.list ? "": "none",
